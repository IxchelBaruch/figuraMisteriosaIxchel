...
public class MyGLRenderer implements GLSurfaceView.Renderer {
    ...
    private figuraMisteriosa myFiguraMisteriosa;
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        myFiguraMisteriosa = new figuraMisteriosa();
    }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        //Matrix.setRotateM(rotationMatrix, 0, mAngle, 0, 0, -1.0f); //Esto es para rotar la figura
        //Matrix.translateM(rotationMatrix, 0, (mAngle/300), 0, 0); //Esto es para mover la figura
        Matrix.scaleM(rotationMatrix, 0, (mAngle/300), (mAngle/300), (mAngle/300)); //Esto escala la figura al toque
        ...
        myFiguraMisteriosa.draw(scratch);
    }
