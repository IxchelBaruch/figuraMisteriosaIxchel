...
public class figuraMisteriosa {
    ...
    static float figuraCoord[] = { //Arreglo (matris) de las coordenadas de un triangulo
            //X, Y, Z
            -0.6f,0.2f,0.0f,
            -0.4f,-0.5f,0.0f,
            0.4f,-0.5f,0.0f,
    ...
    float color[] = {72/255f, 157/255f, 192/255f, 0.0f};
    private final int mProgram;
    //inicializamos nuestra funcion triangulo
    public figuraMisteriosa(){
    ...
    private final int vertexCount = figuraCoord.length / COORDS_PER_VERTEX; //contador de vertices
